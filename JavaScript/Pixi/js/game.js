    ...
    var map = (function(){
        return {
            ...
            init: function(){
                ...
                this.time = new PIXI.Text(game.time, {
                    fontFamily: "Arial",
                    fontSize: 30,
                    fontWeight: '300',
                    fill: "#000",
                ...
                if(!this.aaaa) {
                     // game.app.stage.addChild(this.mask);
                this.aaaa = new pixiContainer();
                this.aaaa.position.set(10, 10);
                this.aaaa.addChild(this.time);
                // this.time.position.set(100, 200);
                
                }else{
                    game.app.stage.removeChild(this.aaaa);
                }
                game.app.stage.addChild(this.aaaa);
